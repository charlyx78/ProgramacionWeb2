  ...
  return (
    <>
      <div className='profile-info-container'>
        ...
        <img src={user.cover_picture != '' ? `${ENDPOINT}/${user.cover_picture}` : gray}
          className='w-100 cover-picture' 
          alt='Profile Picture' 
          onError={(e) => {
            e.target.src = gray
          }} 
        ...
        <div className='profile-into-content w-100'>
          <div className='d-flex justify-content-between align-items-end mb-3'>
            <img src={user.picture != '' ? `${ENDPOINT}/${user.picture}` : avatar} 
              className='profile-info-image rounded-circle' 
              alt='Profile Picture' 
              onError={(e) => {
                e.target.src = avatar
              }} 
